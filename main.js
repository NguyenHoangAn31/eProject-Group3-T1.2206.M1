...
for (var i = 0; i < 5; i++) {
        ...
        <div class="item" style="width:220px" >
                <div class="card text-center">
                    <img onclick="productdetail(${mang[i].id})" src="${mang[i].imgsrc}"   style="width:50%;margin:auto;margin-top:10px" height="175">
                    <h3>${mang[i].name}</h3>
...
mang.forEach(element => {
    ...
    <div class="item">
            <div class="card text-center border-0"">
                <img onclick="productdetail(${element.id})" src="${element.imgsrc}"  style="width:50%;margin:auto;margin-top:10px" height="175">
                <h4>${element.name}</h4>
...
function productdetail(n) {
    var indexarr = mang[n];
    var contain = `<div style="padding-top:100px">

    <div class="h1 text-center pb-5">Product Detail</div>
    <div class="row container justify-content-evenly" style="margin:auto">
      <div style="width: 375px;text-align: center;">
        <img src="${indexarr.imgsrc}" width="350" >
      </div>
